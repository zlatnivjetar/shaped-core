...
function shaped_get_admin_reservation_template( $data ) {
    ...
    <div style="font-family: Arial, sans-serif; font-size: 14px; color: #333; max-width: 600px; border: 1px solid #ddd; border-radius: 5px; margin: 20px auto;">
        ...
        <div style="padding: 20px;">
            ...
            <p style="background: #fffbf0; padding: 10px; border-radius: 3px; border-left: 3px solid #E2BD27;">
...
function shaped_get_admin_deposit_template( $data ) {
    ...
    ?>
    <div style="font-family: Arial, sans-serif; font-size: 14px; color: #333; max-width: 600px; border: 1px solid #ddd; border-radius: 5px; margin: 20px auto;">
        <div style="background-color: #E2BD27; color: white; padding: 15px; border-radius: 5px 5px 0 0;">
        ...
        <div style="padding: 20px;">
            ...
            <p><strong>Balance Due:</strong> <strong style="color: #E2BD27;"><?php echo esc_html( $data['balance_due'] ); ?></strong> (at check-in)</p>
